...
# 4  
...
EOF
        ...
        qrCodeBase64Default=$(echo -n "{\"port\":${currentDefaultPort},\"ps\":\"${email}\",\"tls\":\"tls\",\"id\":\"${id}\",\"aid\":1,\"v\":2,\"host\":\"${currentHost}\",\"type\":\"http\",\"path\":\"/${currentPath}tcp\",\"net\":\"tcp\",\"add\":\"${currentAdd}\",\"allowInsecure\":0,\"method\":\"none\",\"peer\":\"${currentHost}\",\"sni\":\"${currentHost}\"}" | base64 -w 0)
        qrCodeBase64Default="${qrCodeBase64Default// /}"

        echoContent yellow " ---> 通用json(VMess+TCP+TLS)"
        echoContent green "    {\"port\":${currentDefaultPort},\"ps\":\"${email}\",\"tls\":\"tls\",\"id\":\"${id}\",\"aid\":1,\"v\":2,\"host\":\"${currentHost}\",\"type\":\"http\",\"path\":\"/${currentPath}tcp\",\"net\":\"tcp\",\"add\":\"${currentAdd}\",\"allowInsecure\":0,\"method\":\"none\",\"peer\":\"${currentHost}\",\"sni\":\"${currentHost}\"}\n"
...
showAccounts() {
    ...
    if echo ${currentInstallProtocolType} | grep -q 2; then
        echoContent skyBlue "\n================================  VMess TCP TLS  ================================\n"
            local path="${currentPath}tcp"
            if [[ ${coreInstallType} == "1" ]]; then
                path="${currentPath}tcp"
            fi
            jq .inbounds[0].settings.clients ${configPath}04_VMess_TCP_inbounds.json | jq -c '.[]' | while read -r user; do
                ...
                echoContent skyBlue "\n ---> 账号:${email}"
                echo
                defaultBase64Code vmesstcp "${email}" "$(echo "${user}" | jq -r .id)"
        done
    fi
